    ...
    private fun signUpWithEmailPassword() {
        ...
        if (validateInputs(email,password)){
            firebaseAuth.createUserWithEmailAndPassword(email,password)
                .addOnCompleteListener(this) {
                    if (it.isSuccessful) {
                        FancyToast.makeText(this,"Usuario creado correctamente !",FancyToast.LENGTH_LONG,FancyToast.SUCCESS,true).show()
                    }else {
                        FancyToast.makeText(this,"No se pudo crear el usuario !",FancyToast.LENGTH_LONG,FancyToast.ERROR,true).show()
                    }
